...
public:
    ...
    // No se ha usado esto al final, lo dejo en el c�digo igualmente por si es necesario en el futuro
    // Gracias a este m�todo, se pueden copiar colores en formato hexadecimal directamente de otras aplicaciones
